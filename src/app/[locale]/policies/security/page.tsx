...
## 2. 데이터 보존 및 제거
사용자의 개인 정보를 존중하고 해당 규정을 준수하는 것은 AI WORKERS 데이터 보존 및 제거 정책의 핵심 원칙입니다. AI WORKERS의 플랫폼에서 처리되는 모든 파일은 처리 후 3시간 이내에 자동으로 영구 삭제됩니다. 또한 사용자가 다운로드 화면에서 파일을 직접 삭제할 수 있으므로 데이터 수명 주기를 더 주도적으로 통제할 수 있습니다.
`}
          />
        </div>
      </section>
