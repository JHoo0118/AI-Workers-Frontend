"use client";
import DragAndDropAIDocsSummaryFile from "@/components/AI/Docs/DragAndDropAIDocsSummaryFile";
...
export default withDragAndDropFiles(AIDocsSummaryContainer);
